...
<input class="form-check-input tier" type="radio" name="tier" value="starter"
data-tokens="1" data-price="250" checked>

<label class="form-check-label">
<strong>Starter</strong> — 1 print
<span class="text-muted">(₦250)</span>
</label>
</div>

<div class="form-check mb-2">
<input class="form-check-input tier" type="radio" name="tier" value="basic"
data-tokens="5" data-price="1150">

<label class="form-check-label">
<strong>Basic</strong> — 5 prints
<span class="text-muted">(₦1,150)</span>
</label>
</div>

<div class="form-check mb-2">
<input class="form-check-input tier" type="radio" name="tier" value="pro"
data-tokens="15" data-price="3150">

<label class="form-check-label">
<strong>Pro</strong> — 15 prints
<span class="text-muted">(₦3,150)</span>
</label>
</div>

<div class="form-check mb-4">
<input class="form-check-input tier" type="radio" name="tier" value="school"
data-tokens="40" data-price="7200">

<label class="form-check-label">
<strong>School</strong> — 40 prints
<span class="text-muted">(₦7,200)</span>
</label>
</div>
...
<strong><span id="tokens">1</span></strong>
</div>

<div class="d-flex justify-content-between">
<span>Total</span>
<strong>₦<span id="amount">250</span></strong>
</div>
