...
define('BASE_PATH', __DIR__ ."/_{$appName}");
...
require_once  '/core/lib/lib_db.php';
require_once BASE_PATH . '/core/lib/Router.php';
...
$request = str_replace("/_{appName}", '', $_SERVER['REQUEST_URI']);
