...
<!-- Department -->
  ...
  <?php if($department['name'] == "General") 
  {
  //general department is only useful for labeling subjects as core (not useful for students)
  continue;
  }
   ?>
...
/*
async function loadDepartmentsclassId()
{
    const response = await fetch(

        `/<?= $appName ?>/departments/list_all`
