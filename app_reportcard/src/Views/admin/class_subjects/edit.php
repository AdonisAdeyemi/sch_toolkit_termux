...
//for department display (only sss has all dept shown for all subjects)
...
<form id="subjectForm">
 ...
 <div class="subject_dept_container">
                            <?php
 ...
 <?= groupChip($subject['subject_group']) ?>
  ...
  <!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
    ...
    <?php if  ($isJSS &&
 (
($subject['report_subject_id'] == $crs_subject_id)
 ||
($subject['report_subject_id'] == $irs_subject_id)
)
): ?>
                                <?php foreach ($departments as $department): ?>
...
//xxxxx
    ...
    $(this).closest('.subject_dept_container')
